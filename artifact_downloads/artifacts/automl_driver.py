...
workspace_name = "automl-ws-202305180930" # PLACEHOLDER
subscription_id = "29776e82-e128-4f2d-a565-dc6435100c74" # PLACEHOLDER
resource_group = "automl-rg-202305180930" # PLACEHOLDER
experiment_name = "automl-marketing-classifier" # PLACEHOLDER
iteration = "8"  # PLACEHOLDER
run_id = "elated_chaconia_ygd1xh94fg_8"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'path':'./sample_projects/','subscription_id':'29776e82-e128-4f2d-a565-dc6435100c74','resource_group':'automl-rg-202305180930','workspace_name':'automl-ws-202305180930','compute_target':'jobcluster','iterations':10,'primary_metric':'accuracy','task_type':'classification','IsImageTask':False,'IsTextDNNTask':False,'n_cross_validations':5,'preprocess':True,'is_timeseries':False,'time_column_name':None,'grain_column_names':None,'max_cores_per_iteration':-1,'max_concurrent_iterations':2,'max_nodes':1,'iteration_timeout_minutes':1,'enforce_time_on_windows':False,'experiment_timeout_minutes':600,'exit_score':'NaN','experiment_exit_score':'NaN','whitelist_models':['GradientBoosting','XGBoostClassifier','ExtremeRandomTrees'],'auto_blacklist':False,'blacklist_samples_reached':False,'exclude_nan_labels':False,'verbosity':20,'model_explainability':True,'enable_onnx_compatible_models':True,'enable_feature_sweeping':False,'send_telemetry':True,'enable_early_stopping':True,'early_stopping_n_iters':20,'distributed_dnn_max_node_check':False,'enable_distributed_featurization':True,'enable_distributed_dnn_training':True,'enable_distributed_dnn_training_ort_ds':False,'ensemble_iterations':10,'enable_tf':False,'enable_cache':False,'enable_subsampling':False,'metric_operation':'maximize','enable_streaming':False,'use_incremental_learning_override':False,'force_streaming':False,'enable_dnn':False,'is_gpu_tmp':False,'enable_run_restructure':False,'featurization':'auto','vm_priority':'dedicated','label_column_name':'y','weight_column_name':None,'miro_flight':'default','many_models':False,'many_models_process_count_per_node':0,'automl_many_models_scenario':None,'enable_batch_run':True,'save_mlflow':True,'track_child_runs':True,'test_include_predictions_only':False,'enable_mltable_quick_profile':'True','has_multiple_series':False,'_enable_future_regressors':False,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_download_models_timeout_sec':300.0,'stack_meta_learner_train_percentage':0.2,'vm_type':'STANDARD_DS3_V2','blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN']} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'classification','primary_metric':'accuracy','verbosity':20,'ensemble_iterations':10,'ensemble_download_models_timeout_sec':300,'is_timeseries':False,'compute_target':'jobcluster','subscription_id':'29776e82-e128-4f2d-a565-dc6435100c74','time_column_name':None,'grain_column_names':None}\",\"ensemble_run_id\":\"elated_chaconia_ygd1xh94fg_8\",\"experiment_name\":\"automl-marketing-classifier\",\"workspace_name\":\"automl-ws-202305180930\",\"subscription_id\":\"29776e82-e128-4f2d-a565-dc6435100c74\",\"resource_group_name\":\"automl-rg-202305180930\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = None # PLACEHOLDER
mltable_data_json = "{\"Type\":\"MLTable\",\"TrainData\":{\"Uri\":\"/subscriptions/29776e82-e128-4f2d-a565-dc6435100c74/resourceGroups/automl-rg-202305180930/providers/Microsoft.MachineLearningServices/workspaces/automl-ws-202305180930/data/marketing_data/versions/1\",\"ResolvedUri\":\"azureml://subscriptions/29776e82-e128-4f2d-a565-dc6435100c74/resourcegroups/automl-rg-202305180930/workspaces/automl-ws-202305180930/datastores/workspaceblobstore/paths/LocalUpload/d926593d45e87eade0c99a9d1f76a6c4/marketing/\",\"AssetId\":\"azureml://locations/eastus/workspaces/356fef79-f387-4845-a1b2-e06bdf57b8b3/data/marketing_data/versions/1\"},\"TestData\":null,\"ValidData\":null}" # PLACEHOLDER
